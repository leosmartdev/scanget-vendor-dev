...
class LoginForm extends Component {
  ...
  static FormInput = ({ getFieldDecorator, placeholder, name, message, type, autoFocus }) => {
    return <FormItem hasFeedback>
      ...
      })(<Input size='large' placeholder={placeholder} type={type} autoFocus={autoFocus} />)}
    </FormItem>
  }
  ...
  static Form = ({ form, loading, onSubmit }) => {
    ...
    return <Form onSubmit={onSubmit}>
      <LoginForm.FormInput getFieldDecorator={getFieldDecorator} message="Please Enter Your Email" name="email" placeholder="Email" type="text" autoFocus />
